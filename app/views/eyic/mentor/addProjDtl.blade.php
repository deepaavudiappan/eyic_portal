	...
	<div class="col-md-9" style="margin-top: 25px;">	
		...
		<div class="panel panel-default" style="border:0px;">
			...
			<div class="form-group @if ($errors->has('std2_email')) has-error @endif">
				<label class="control-label" for="lbl_std2">Student Coordinator (1st Student) Email:</label>
			...
			<div class="form-group @if ($errors->has('std3_email')) has-error @endif">
				<label class="control-label" for="lbl_std3">Student Coordinator (1st Student) Email:</label>
			...
			<div class="form-group @if ($errors->has('std4_email')) has-error @endif">
				<label class="control-label" for="lbl_std4">Student Coordinator (1st Student) Email:</label>
