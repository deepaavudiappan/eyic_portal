	...
	<div class="panel-body">
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				...
				<br/>
				<div class="alert alert-info">Please fill in the details to register your team of four teachers on or before <strong>January 26th 2015. Please make sure that <strong>if selected</strong>, all the members of your team will attend the workshop.</strong></div><br/>
