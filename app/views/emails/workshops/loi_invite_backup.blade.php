...
<li>Please confirm your attendance on or before {{$last_date}} by visiting here: <a href="http://elsiportal.e-yantra.org/elsi/workshop/college/confirm_land_loi?ct={{ $token }}">http://elsiportal.e-yantra.org/elsi/workshop/college/confirm_land_loi?ct={{$token}}</a></li>
